...
void AFPSProjectiles::OnHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent,
	FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if(OtherActor != nullptr)
	{
		if(OtherActor->ActorHasTag("Enemy_1"))
		{
			...
			GEngine->AddOnScreenDebugMessage(-1,3.f,FColor::Black,FString::Printf(TEXT("Hitted Enemy with Rifle")));
